...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    fellowshipReferenda: {
       ...
       * See [`Pallet::submit`].
       **/
      submit: AugmentedSubmittable<(proposalOrigin: AutographParachainRuntimeOriginCaller | { system: any } | { Void: any } | { Origins: any } | { CumulusXcm: any } | { PolkadotXcm: any } | { Ethereum: any } | string | Uint8Array, proposal: FrameSupportPreimagesBounded | { Legacy: any } | { Inline: any } | { Lookup: any } | string | Uint8Array, enactmentMoment: FrameSupportScheduleDispatchTime | { At: any } | { After: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AutographParachainRuntimeOriginCaller, FrameSupportPreimagesBounded, FrameSupportScheduleDispatchTime]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    refungible: {
       ...
       **/
      createItem: AugmentedSubmittable<(collectionId: u32 | AnyNumber | Uint8Array, data: PalletRefungibleCreateItemData | { balances?: any; properties?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, PalletRefungibleCreateItemData]>;
      /**
       * See [`Pallet::create_multiple_items`].
       **/
      createMultipleItems: AugmentedSubmittable<(collectionId: u32 | AnyNumber | Uint8Array, data: Vec<PalletRefungibleCreateItemData> | (PalletRefungibleCreateItemData | { balances?: any; properties?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [u32, Vec<PalletRefungibleCreateItemData>]>;
      /**
       ...
       **/
      initCollection: AugmentedSubmittable<(data: CollectionPrimitivesCreateRftCollectionData | { name?: any; description?: any; tokenPrefix?: any; limits?: any; propertyPermissions?: any; properties?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [CollectionPrimitivesCreateRftCollectionData]>;
      /**
       ...
       **/
      setCollectionProperties: AugmentedSubmittable<(collectionId: u32 | AnyNumber | Uint8Array, properties: Vec<CollectionPrimitivesPropertiesProperty> | (CollectionPrimitivesPropertiesProperty | { key?: any; value?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [u32, Vec<CollectionPrimitivesPropertiesProperty>]>;
      /**
       * See [`Pallet::set_collection_property`].
       **/
      setCollectionProperty: AugmentedSubmittable<(collectionId: u32 | AnyNumber | Uint8Array, property: CollectionPrimitivesPropertiesProperty | { key?: any; value?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, CollectionPrimitivesPropertiesProperty]>;
      /**
       * See [`Pallet::set_property_permission`].
       **/
      setPropertyPermission: AugmentedSubmittable<(collectionId: u32 | AnyNumber | Uint8Array, propertyPermission: CollectionPrimitivesPropertiesPropertyKeyPermission | { key?: any; permission?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, CollectionPrimitivesPropertiesPropertyKeyPermission]>;
      /**
       * See [`Pallet::set_token_properties`].
       **/
      setTokenProperties: AugmentedSubmittable<(collectionId: u32 | AnyNumber | Uint8Array, tokenId: u32 | AnyNumber | Uint8Array, properties: Vec<CollectionPrimitivesPropertiesProperty> | (CollectionPrimitivesPropertiesProperty | { key?: any; value?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [u32, u32, Vec<CollectionPrimitivesPropertiesProperty>]>;
      /**
       * See [`Pallet::set_token_property`].
       **/
      setTokenProperty: AugmentedSubmittable<(collectionId: u32 | AnyNumber | Uint8Array, tokenId: u32 | AnyNumber | Uint8Array, property: CollectionPrimitivesPropertiesProperty | { key?: any; value?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u32, CollectionPrimitivesPropertiesProperty]>;
      /**
       * See [`Pallet::transfer`].
       **/
    ...
    session: {
       ...
       * See [`Pallet::set_keys`].
       **/
      setKeys: AugmentedSubmittable<(keys: AutographParachainRuntimeSessionKeys | { aura?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AutographParachainRuntimeSessionKeys, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    whitelist: {
       ...
       **/
      addInvestor: AugmentedSubmittable<(investor: PalletWhitelistAddInvestorData | { key?: any; account?: any; isActive?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletWhitelistAddInvestorData]>;
      /**
