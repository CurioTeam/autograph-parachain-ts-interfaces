...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        access: {
             ...
             **/
            RoleGranted: AugmentedEvent<ApiType, [account: AccountId32, role: AutographParachainRuntimeRole], {
                account: AccountId32;
             ...
             **/
            RoleTaken: AugmentedEvent<ApiType, [account: AccountId32, role: AutographParachainRuntimeRole], {
                account: AccountId32;
                role: AutographParachainRuntimeRole;
            }>;
            /**
        ...
        baseFee: {
            ...
            NewElasticity: AugmentedEvent<ApiType, [elasticity: Permill], {
                elasticity: Permill;
            }>;
            /**
             * Generic event
        ...
        scheduler: {
             ...
             **/
            CallUnavailable: AugmentedEvent<ApiType, [task: ITuple<[u64, u32]>, id: Option<U8aFixed>], {
                task: ITuple<[u64, u32]>;
                id: Option<U8aFixed>;
            }>;
            /**
             * Canceled some task.
             **/
            Canceled: AugmentedEvent<ApiType, [when: u64, index: u32], {
                when: u64;
                index: u32;
            }>;
            /**
             ...
             **/
            Dispatched: AugmentedEvent<ApiType, [task: ITuple<[u64, u32]>, id: Option<U8aFixed>, result: Result<Null, SpRuntimeDispatchError>], {
                task: ITuple<[u64, u32]>;
                id: Option<U8aFixed>;
                result: Result<Null, SpRuntimeDispatchError>;
            }>;
             ...
             **/
            PeriodicFailed: AugmentedEvent<ApiType, [task: ITuple<[u64, u32]>, id: Option<U8aFixed>], {
                task: ITuple<[u64, u32]>;
                id: Option<U8aFixed>;
            }>;
            /**
             ...
             **/
            PermanentlyOverweight: AugmentedEvent<ApiType, [task: ITuple<[u64, u32]>, id: Option<U8aFixed>], {
                task: ITuple<[u64, u32]>;
                id: Option<U8aFixed>;
            }>;
            /**
             * Scheduled some task.
             **/
            Scheduled: AugmentedEvent<ApiType, [when: u64, index: u32], {
                when: u64;
                index: u32;
            }>;
            /**
        ...
        whitelist: {
             ...
             **/
            AddInvestor: AugmentedEvent<ApiType, [key: U8aFixed, account: AccountId32, isActive: bool], {
                key: U8aFixed;
                account: AccountId32;
                isActive: bool;
            }>;
             ...
             **/
            RemoveInvestor: AugmentedEvent<ApiType, [key: U8aFixed, account: AccountId32], {
                key: U8aFixed;
                account: AccountId32;
            }>;
            /**
             ...
             **/
            SetInvestorStatus: AugmentedEvent<ApiType, [key: U8aFixed, isActive: bool], {
                key: U8aFixed;
                isActive: bool;
            }>;
            /**
